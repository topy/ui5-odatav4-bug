 ...
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
 */
sap.ui.predefine("sap/m/designtime/ObjectIdentifier.designtime",["sap/m/library","sap/base/Log"],function(e,t){"use strict";var i;return{palette:{group:"DISPLAY",icons:{svg:"sap/m/designtime/ObjectIdentifier.icon.svg"}},registerSettingsHandler:function(e){i=e},getStableElements:function(e){return i?i.getStableElements(e):null},actions:{settings:function(){if(!i){return}if(!i.isSettingsAvailable()){t.error("sap.ui.comp.navpopover.ObjectIdentifier.designtime: 'settings' action is not available");return}return{handler:function(e,t){return i.execute(e,t)}}}},templates:{create:"sap/m/designtime/ObjectIdentifier.create.fragment.xml"}}});
/*!
 * OpenUI5
 * (c) Copyright 2009-2021 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
 ...
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
 */
sap.ui.predefine("sap/m/designtime/StandardListItem.designtime",[],function(){"use strict";return{actions:{rename:{changeType:"rename",domRef:function(e){return e.$().find(".sapMLIBContent > .sapMSLIDiv > .sapMSLITitleOnly")[0]||e.$().find(".sapMLIBContent > .sapMSLIDiv > .sapMSLITitle")[0]}}}}});
/*!
 * OpenUI5
 * (c) Copyright 2009-2021 SAP SE or an SAP affiliate company.
 * Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
